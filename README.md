...
At the first stage to achieve an intuition we used both pearson and spearman correlation to detect both respectively liner and monotonic relationship relation between each factor and our target. 
